...
from config import CAMERA_PREVIEW_WIDTH, CAMERA_PREVIEW_HEIGHT, SYSTEM_UI_FONT, SYSTEM_EMOJI_FONT
...
class CameraWidget(QWidget):
    ...
    def _draw_placeholder(self, painter: QPainter):
        ...
        icon_font = QFont(SYSTEM_EMOJI_FONT, 32)
        painter.setFont(icon_font)
        painter.drawText(self.rect(), Qt.AlignmentFlag.AlignCenter, "📷")

        # "No camera" text below
        painter.setPen(QColor("#5a5a7a"))
        text_font = QFont(SYSTEM_UI_FONT, 10)
